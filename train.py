...
def get_dataset(datasetnames):
    names = datasetnames.split('+')  # ['voc_2007_trainval', 'voc_2012_trainval']
...
def train():
    ...
    args.pretrained_model = os.path.join('checkpoints', 'darknet19_448.weights')
    args.checkpoint_epoch = 'darknet19_448.weights'
    ...
    if args.resume:
        ...
        resume_checkpoint_name = args.checkpoint_epoch
    ...
    for epoch in range(args.start_epoch, args.max_epochs+1):
        ...
        for step in range(iters_per_epoch):
            ...
            box_loss, iou_loss, class_loss = model(im_data, boxes, gt_classes, num_obj, training=True)
